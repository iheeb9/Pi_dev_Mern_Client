                      ...
                      <div class="navbar-collapse">
                        <div class="nav-inner">
                          <ul class="nav main-menu menu navbar-nav">
                            ...
                            <li>
                              <a href="#">
                                Buy and Sell on Eshop
                                <i class="ti-angle-down"></i>
                              </a>
                              <ul class="dropdown">
                                <li>
                                  {" "}
                                  <Link to={"/annonce"}>Buy Products</Link>
                                </li>
                                <li>
                                  {" "}
                                  <Link to={"/addannonce"}>Sell Products</Link>
                                </li>
                              </ul>
                            </li>
                            <li>
                              <a href="#">
                                Auction<i class="ti-angle-down"></i>
                                <span class="new">$</span>
                              </a>
                              <ul class="dropdown">
                                <li>
                            ...
                            <li>
                              <a href="#">
                                Prototype<i class="ti-angle-down"></i>
                                <span class="new">New</span>
                              </a>
                              <ul class="dropdown">
                                <li>
                                  {" "}
                                  <Link to={"/shareprototype"}>
                                    Share protoype
                                  </Link>
                                </li>
