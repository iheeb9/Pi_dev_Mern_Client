...
export default function UpdateAnnonce(props) {
...
const [annonceData, setannonceData] = useState(initialState)
    ...
    const updatepost = post.posts.filter((post) => post._id === id)[0];
    
    const {title, content, price, cathegorie, tags ,location} = annonceData
  
    useEffect(()=>{
        if (updatepost) {   
         setannonceData(updatepost)
         setimages(updatepost.images)
        }
    },[updatepost])
...
const handlesubmit = (e)=>{
    e.preventDefault()
    if (images.length==0)return dispatch({type:'NOTIFY',payload:{error:"Please add you Photo"}})
    dispatch(updatePost({annonceData,images,auth,id,history}))
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="title" type="text" placeholder="" value={title}
										...
										<div class="col-lg-6 col-12" >
											...
											<div class="form-group" >
                                                ...
                                                <select class="custom-select" name="cathegorie" id="inputGroupSelect01"
                                                 onChange={handleChangeInput} >
                                                    <option selected value={cathegorie}>{cathegorie}</option>
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="price" type="text" placeholder="" value={price}
                                                 onChange={handleChangeInput}/>
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="location" type="text" placeholder="" value={location}
                                                 onChange={handleChangeInput}/>
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												...
												<textarea name="content" placeholder="" value={content}
                                        ...
                                        <div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="tags" type="text" placeholder="" value={tags}
                                                 onChange={handleChangeInput}/>
											</div>	
										</div>
                                        <div class="col-lg-6 col-12">
